    ...
    public String queryPayOrder(@RequestParam String params) {
        ...
        try {
            ...
            if (!"success".equalsIgnoreCase(errorMessage)) {
                ...
                return SinoPayUtil.makeRetFail(SinoPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, errorMessage, null, null));
            }
            ...
            if(!"0000".equals(retObj.getString("code"))) {
                return SinoPayUtil.makeRetFail(SinoPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, retObj.getString("msg"), null, null));
            }
            payOrder = retObj.getJSONObject("result");
            if (payOrder == null) {
                return SinoPayUtil.makeRetFail(SinoPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "支付订单不存在", null, null));
            }
            ...
            return SinoPayUtil.makeRetData(map, payContext.getString("resKey"));
        }catch (Exception e) {
            _log.error(e, "");
