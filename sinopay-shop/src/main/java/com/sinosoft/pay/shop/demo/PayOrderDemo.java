...
import com.sinosoft.pay.common.util.PayDigestUtil;
...
public class PayOrderDemo {
    ...
    // 加签key
    static final String reqKey = "jieshuntest123!@#";
    // 验签key
    static final String repKey = "jieshuntest123!@#";

    static final String baseUrl = "http://localhost:3020/api";
//    static final String baseUrl = "http://shzkr.imwork.net:27508/api";
    static final String notifyUrl = "http://www.baidu.com"; // 本地环境测试,可到ngrok.cc网站注册
//    static final String notifyUrl = "http://oa.sinosoftzx.cn:8081/goods/payNotify";
